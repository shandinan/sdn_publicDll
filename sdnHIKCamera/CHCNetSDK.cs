/*
 * 此类是结合海康提供的c++SDK 及网络上一些对海康SDK的CSharp封装，
 * 并且根据苏州车管所视频监控系统和苏州交巡警支队 非现场执法事后处理系统 车辆检测监管系统 的实际需求编写
 * 作者：单氐楠
 * 日期：2014-08-05
 * 注意：由于实际情况不同，此类是在官网和网络上提供的类的基础上改变而来，但与厂家提供的类不同，
 *       故未经作者同意，严禁修改，否则一切后果自负！
 * 修改记录：2014-11-02 修改取流的回掉函数
 * 最后修改时间：2015-09-04
 * */
using System;
    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public struct NET_DVR_CAMERAPARAMCFG_EX
        {
            ...
            /*0-关闭、1-640*48025fps、2-640*48030ps、3-704*57625fps、4-704*48030fps、5-1280*72025fps、6-1280*72030fps、
             * 7-1280*72050fps、8-1280*72060fps、9-1280*96015fps、10-1280*96025fps、11-1280*96030fps、
             * 12-1280*102425fps、13--1280*102430fps、14-1600*90015fps、15-1600*120015fps、16-1920*108015fps、
             * 17-1920*108025fps、18-1920*108030fps、19-1920*108050fps、20-1920*108060fps、21-2048*153615fps、22-2048*153620fps、
             * 23-2048*153624fps、24-2048*153625fps、25-2048*153630fps、26-2560*204825fps、27-2560*204830fps、
             * 28-2560*19207.5fps、29-3072*204825fps、30-3072*204830fps、31-2048*153612.5、32-2560*19206.25、
             * 33-1600*120025、34-1600*120030、35-1600*120012.5、36-1600*90012.5、37-160090015、38-800*60025、39-800*60030*/
        ...
        **********************************************************/
		...
		Return:	void   单氐楠 修改
		**********************************************************/
        public delegate void REALDATACALLBACK_1(Int32 lRealHandle, UInt32 dwDataType, ref byte pBuffer, UInt32 dwBufSize, IntPtr pUser);
        /*********************************************************
         //为了满足非现场执法事后处理系统而添加， 单氐楠  2014-12-05
      Function:	REALDATACALLBACK
      Desc:		预览回调
      Input:	lRealHandle 当前的预览句柄 
              dwDataType 数据类型
